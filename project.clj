(defproject zcoin-wallet "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "zcoin-wallet.core/on-js-reload"
                ...
                :compiler {:main zcoin-wallet.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/zcoin_wallet.js"
